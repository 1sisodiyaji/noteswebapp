...
//       `${config.BASE_URL}/notes/updateNotes/${id}`,{content: updatedNotesData},
//       {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
...
//                   <div className="btn btn-sm bg-warning text-white" 
//                   onClick={() => 
//                   {  
//                     SetUpdatedNotesData(note.content)
...
//                       <textarea name="updateModelData" id="updateModelData"
//                        value={updatedNotesData} rows={10} onChange={(e) => handleNoteChange(e.target.value)}
